 ...
 <!--<%-- Beginner menu begins --%>-->
        ...
        <ul class="clearfix">
            <li><a href="#">Chest<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                    <li><a href="#" id="beg_ch_babypushup" onClick="toggle('beg_ch_babypushup_div');">Baby Push Ups</a></li>
            ...
            <ul class="sub-menu">
                    ...
                    <li><a href="#" id="beg_tr_behindnecktriceps" onClick="toggle('beg_tr_behindnecktriceps_div');">Behind Neck Triceps</a></li>
                    </ul>
            </li>
            
            <li><a href="#">Shoulders<span class="arrow">&#9660;</span></a>
            <ul class="sub-menu">
                    <li><a href="#" id="beg_sh_dumbellmilitarypress" onClick="toggle('beg_sh_dumbellmilitarypress_div');">Dumbbell Military Press</a></li>
            ...
            <ul class="sub-menu">
                    <li><a href="#" id="beg_lb_forwardbend" onClick="toggle('beg_lb_forwardbend_div');">Forward Bend</a></li>
            ...
            <ul class="sub-menu">
                    <li><a href="#" id="beg_bi_bicepscurl" onClick="toggle('beg_bi_bicepscurl_div');">Biceps Curl</a></li>
                    <li><a href="#" id="beg_bi_seateddumbellcurl" onClick="toggle('beg_bi_seateddumbellcurl_div');">Seated Dumbbell Curl</a></li>
 ...
 <h3 align="center" class="tittle">Intermediate Workout</h3>
  <div class="menu-wrap">
        ...
        <ul class="clearfix">
            <li><a href="#">Chest<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                    <li><a href="#" id="int_ch_babypushup" onClick="toggle('int_ch_babypushup_div');">Baby Push Ups</a></li>
                    ...
                    <li><a href="#" id="int_ch_planebenchdumbellfly" onClick="toggle('int_ch_planebenchdumbellfly_div');">Plane Bench Dumbell Fly</a></li>
                    <li><a href="#" id="int_ch_pecfly" onClick="toggle('int_ch_pecfly_div');">Pec Fly</a></li>
                </ul>
            </li>
            ...
            <ul class="sub-menu">
                    ...
                    <li><a href="#" id="int_tr_pullycabletricepextension" onClick="toggle('int_tr_pullycabletricepextension_div');">Pully Cable Tricep Extension</a></li>
            ...
            <ul class="sub-menu">
                    ...
                    <li><a href="#" id="int_sh_barbelldumbellmilitarypress" onClick="toggle('int_sh_barbelldumbellmilitarypress_div');">Barbell Dumbell Military Press</a></li>
                    <li><a href="#" id="int_sh_uprightrowonpullycable" onClick="toggle('int_sh_uprightrowonpullycable_div');">Up Right Row on Pully Cable</a></li>
            ...
            <li><a href="#">Lower Back<span class="arrow">&#9660;</span></a>
            <ul class="sub-menu">
                    <li><a href="#" id="int_lb_forwardbend" onClick="toggle('int_lb_forwardbend_div');">Forward Bend</a></li>
            ...
            <li><a href="#">Biceps<span class="arrow">&#9660;</span></a>
            <ul class="sub-menu">
                    <li><a href="#" id="int_bi_bicepscurl" onClick="toggle('int_bi_bicepscurl_div');">Biceps Curl</a></li>
                    <li><a href="#" id="int_bi_seateddumbellcurl" onClick="toggle('int_bi_seateddumbellcurl_div');">Seated Dumbbell Curl</a></li>
                    <li><a href="#" id="int_bi_singlearmpreachercurl" onClick="toggle('int_bi_singlearmpreachercurl_div');">Single Arm Preacher Curl</a></li>
        ...
        <ul class="clearfix">
            <li><a href="#">Chest<span class="arrow">&#9660;</span></a>
                <ul class="sub-menu">
                    ...
                    <li><a href="#" id="adv_ch_inclinebenchdumbellpress" onClick="toggle('adv_ch_inclinebenchdumbellpress_div');">Incline Bench Dumbell Fly</a></li>
            ...
            <li><a href="#">Shoulders<span class="arrow">&#9660;</span></a>
            <ul class="sub-menu">
                    <li><a href="#" id="adv_sh_barbellmilitaryprss" onClick="toggle('adv_sh_barbellmilitarypress_div');">Barbell Military Press</a></li>
                    <li><a href="#" id="adv_sh_dumbellmilitarypress" onClick="toggle('adv_sh_dumbellmilitarypress_div');">Dumbbell military Press</a></li>
                    <li><a href="#" id="adv_sh_uprightrowonpullycable" onClick="toggle('adv_sh_uprightrowonpullycable_div');">Up Right Row on Pully Cable</a></li>
                    <li><a href="#" id="adv_sh_frontraise" onClick="toggle('adv_sh_frontraise_div');">Front Raise</a></li>
                    <li><a href="#" id="adv_sh_lateralriase" onClick="toggle('adv_sh_lateralriase_div');">Lateral Raise</a></li>
            ...
            <ul class="sub-menu">
                    ...
                    <li><a href="#" id="adv_lb_hperextension" onClick="toggle('adv_lb_hperextension_div');">Hyperextension</a></li>
            ...
            <ul class="sub-menu">
                    ...
                    <li><a href="#" id="adv_legextension" onClick="toggle('adv_lg_legextension_div');">Leg Extension</a></li>
            ...
            <li><a href="#">Biceps<span class="arrow">&#9660;</span></a>
            <ul class="sub-menu">
                    <li><a href="#" id="adv_bi_barbellcurl" onClick="toggle('adv_bi_barbellcurl_div');">Barbbell Curl</a></li>
                    <li><a href="#" id="adv_bi_seateddumbellcurl" onClick="toggle('adv_bi_seateddumbellcurl_div');">Seated Dumbbell Curl</a></li>
...
<div id="beg_ch_babypushup_div" class="exercises" style="display:none;">
<br/><br/>
		...
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center"> Baby Push Up</h4>
                    ...
                    <h5 align="center">Repetition: 15</h5>
                    <h5 align="center">Sets: 02</h5>
...
<img src="images/baby push up.gif" width="500px" height="500px" style="float:right; border:medium"/>
</td></tr></table>
<!--<%-- Copy ends here --%>-->
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Plane Bench Dumbbell Fly</h4>
                    ...
                    <h5 align="center">Repetition: 15 Reps with constant weight</h5>
                    <h5 align="center">Sets: 03</h5>
...
<img src="images/Dumbbel Triceps Extension.gif" width="500px" height="500px" style="float:right; border:medium"/>
</td></tr></table>
</div>
<div id="beg_tr_behindnecktriceps_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Dumbbell Military Press</h4>
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Front Rasie</h4>
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Lateral Rasie</h4>
...
<div id="beg_lb_forwardbend_div" class="exercises" style="display:none;">
<br/><br/>
<!--<%-- Repeat this for every exercise of every level for both Men and women. Just change the images,heading, facts as per exercise. copy starts here--%>-->
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Forward Bend</h4>
					<h5 align="left">We use forward bend to work the entire SBL: to both stretch and strengthen (depending on the pose) the muscles along the spine, as well as the muscles of the shoulder and pelvic girdles, and legs.</h5>
					<h5 align="left"></h5>
                    <h5 align="center">Repetition: 15 Reps with constant weight</h5>
                    <h5 align="center">Sets: 03</h5>
...
<!-- Begineer Biceps Begins -->

<div id="beg_bi_bicepscurl_div" class="exercises" style="display:none;">
<br/><br/>
<!--<%-- Repeat this for every exercise of every level for both Men and women. Just change the images,heading, facts as per exercise. copy starts here--%>-->
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Biceps Curl</h4>
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Seated Dumbbell Curl</h4>
...
<img src="images/Hammer.gig" width="500px" height="500px" style="float:right; border:medium"/>
</td></tr></table>
</div>

<!-- begineer biceps ends -->
...
<div id="int_ch_babypushup_div" class="exercises" style="display:none;">
<br/><br/>
<!--<%-- Repeat this for every exercise of every level for both Men and women. Just change the images,heading, facts as per exercise. copy starts here--%>-->
<table><tr>
<td style="width:800px; height:400px;" >
...
<div id="int_tr_pullycabletricepextension_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<div id="int_sh_barbelldumbellmilitarypress_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<div id="int_sh_uprightrowonpullycable_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Up Right Row on Pully Cable</h4>
...
<div id="int_lb_forwardbend_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<!-- intermediate biceps starts -->

<div id="int_bi_bicepscurl_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Biceps Curl on low Pulley</h4>
					<h5 align="left">At the start of the curl, when the arm is fairly straight ,180° angle at the elbow, the brachialis and brachioradialis do most of the work lifting the weight up until the halfway point of the exercise, when the elbow angle is about 90°. </h5>
					<h5 align="left"></h5>
                    <h5 align="center">Repetition: 15 Reps with constant weight</h5>
                    <h5 align="center">Sets: 03</h5>
...
<img src="images/biceps-SeatedDumbbellInnerBicepsCurl.gi" width="500px" height="500px" style="float:right; border:medium"/>
</td></tr></table>
</div>
<div id="int_bi_singlearmpreachercurl_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		...
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					...
					<h5 align="left">Perform a standard pushup by lying horizontally on the floor with your hands palms down and out to your side slightly wider than your shoulders.</h5>
					<h5 align="left">Pushups typically focus on the pectorals, triceps and shoulders. A standard pushup works all three muscle groups equally.</h5>
                    <h5 align="center">Repetition:Decreasing order (15, 12, 10)</h5>
                    <h5 align="center">Sets: 03</h5>
...
<div id="adv_ch_planebechdumbellfly_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		...
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					...
					<h5 align="left">The muscle that takes on the greatest percentage of the load during the bench dip is the triceps muscle at the back of each of your upper arms.</h5>
...
<div id="adv_sh_barbellmilitarypress_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<div id="adv_sh_uprightrowonpullycable_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<img src="images/facepull.gi" width="500px" height="500px" style="float:right; border:medium"/>
</td></tr></table>
</div>
...
<div id="adv_lb_hperextension_div" class="exercises" style="display:none;">
<br/><br/>
<table><tr>
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
...
<td style="width:800px; height:400px;" >
	<div class="about-section" id="about">
		<div class="container">
			  <div class="ab-top">
				<div class="col-md-7 about-top">
					<h4 align="center">Incline Dumbbell Curl</h4>
