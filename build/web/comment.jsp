 ...
 .c{
    ...
    <div class="nav">
      ...
      <ul>
         ...
         <li class="order"><a href="vieworders.jsp">Orders</a></li>
        
        <li class="logout"><a href="home.jsp">Logout</a></li>
        
      </ul>
        <div class="a">
          <font color="indianred">Comment here...</font><br><br>
        ...
        function validate()
      {
        ...
        <br><br> <hr>
        <center> <div class="a"><h2><font color="indianred">View Questions and Comments...</font></h2></div></center>
        <img style="position:absolute; TOP:650px; right: 170px; WIDTH:300px; HEIGHT:200px" SRC="images/images.jpg">
            ...
            <%
                     ...
                     <%
                             ...
                             while(rs.next())
                             {
                                 ...
                                 <div class="a">  <b> Name: </b><%=name%><br>
                                     <b> Comments:</b>  <div class="c">  <%=comment%> </div>  <a href="deletecomment.jsp?name=<%=name%>" ><font color="black"><b>Delete</b></font> </a>  </div>                        
